...
(function () {
    ...
    const textInput = document.querySelector("#messenger_input");
    const chatbox = document.querySelector("#message_window footer");
    textInput.addEventListener("focus", () => chatbox.classList.add("focus"));
    textInput.addEventListener("blur", () => chatbox.classList.remove("focus"));

    microphone(Botkit.send.bind(Botkit));
